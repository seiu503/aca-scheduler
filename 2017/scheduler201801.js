...
// Q2: Marketplace Plan?
// show Q5 (Which state) if Mktplace plan,
...
// Q3: Other coverage?
// route to Q3.5 (SEP) if No,
// if Yes show Q4 (OC warning)
...
// Q3.5 outside OE period only
// If meet SEP guidelines, route to Q4 (Other coverage warning). Otherwise show check back SEP.

  $(".SEP").change(function() {
     if ($("#SEP_6").is(':checked')) { // None of the above, route to SEP education msg
      $("#T15").show(); // check back SEP outside OE
      $("#OC-warning").hide(); // other coverage warning
    } else if ($("#SEP_5").is(':checked') ||
               $("#SEP_4").is(':checked') ||
               $("#SEP_3").is(':checked') ||
               $("#SEP_2").is(':checked') ||
               $("#SEP_1").is(':checked') ||
               $("#SEP_0").is(':checked')) { // SEP eligible, show state question
      sep = false;
      $("#T15").hide(); //check back SEP outside OE
      $("#OC-warning").show(); // other coverage warning
    }
  });
