...
// Over income => Q11 (EHH)
 ...
 $(".TaxHH").change(function() {
    if ($('input:radio[name=TaxHH]:checked').val() == 1 && $('input[name=Income]').val() < 1436) {
    ...
    } else if ($('input:radio[name=TaxHH]:checked').val() == 1 && $('input[name=Income]').val() >= 1436) {
      $("#T10").hide(); // call OHA
      $("#T16").hide(); // WA Apple Care
      $("#EHH").show(); // How many people enrolling?
    } else if ($('input:radio[name=TaxHH]:checked').val() == 2 && $('input[name=Income]').val() < 1945) {
      if ($("#State_0").is(':checked')) {
        $("#T10").show(); // call OHA
        $("#T16").hide(); // WA Apple Care
        $("#EHH").hide(); // How many people enrolling?
      ...
      $("#T16").hide(); // WA Apple Care
      $("#EHH").show(); // How many people enrolling?
    } else if ($('input:radio[name=TaxHH]:checked').val() == 3 && $('input[name=Income]').val() < 2453) {
      if ($("#State_0").is(':checked')) {
        $("#T10").show(); // call OHA
        $("#T16").hide(); // WA Apple Care
        $("#EHH").hide(); // How many people enrolling?
      ...
      $("#T16").hide(); // WA Apple Care
      $("#EHH").show(); // How many people enrolling?
    } else if ($('input:radio[name=TaxHH]:checked').val() == 4 && $('input[name=Income]').val() < 2961) {
      if ($("#State_0").is(':checked')) {
        $("#T10").show(); // call OHA
        $("#T16").hide(); // WA Apple Care
        $("#EHH").hide(); // How many people enrolling?
      ...
      $("#T16").hide(); // WA Apple Care
      $("#EHH").show(); // How many people enrolling?
    } else if ($('input:radio[name=TaxHH]:checked').val() == 5 && $('input[name=Income]').val() < 3470) {
      if ($("#State_0").is(':checked')) {
        $("#T10").show(); // call OHA
        $("#T16").hide(); // WA Apple Care
        $("#EHH").hide(); // How many people enrolling?
